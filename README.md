...
| Commit | Description |
|--------|-------------|
| Initial commit | Project setup with HTML, CSS, JS folders |
| Add Task constructor | Created Task with description, priority, completed |
| Add Task prototypes | Added toggleComplete and getDisplayText |
| Add ToDoList constructor | Created ToDoList with tasks array |
| Add addTask method | Can add tasks to the list |
| Add removeTask method | Can remove tasks by ID |
| Add getTasks filter | Can filter by all/active/completed |
| Add getStats method | Shows completion statistics |
| Add UI HTML | Created form and task list structure |
| Add CSS styling | Styled the application |
| Add UI JavaScript | Connected business logic to DOM |
| Add filter buttons | Can filter tasks in UI |
| Add stats display | Shows task statistics |
| Update README | Added tests and documentation |
| Final polish | Bug fixes and styling improvements |
